...
void tools::print_intermediate_result(
        DataInitializer* data, int iteration_number, double error) {
    ...
    std::cout << "Compute delta: " << data->intermediate_results[2] << "\n";
    std::cout << "Update points: " << data->intermediate_results[3] << "\n";
